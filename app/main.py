...
#Description
st.write("Welcome to the brain tumor classification tool powered by Convolutional Neural Networks! This website allows you to upload an X-ray image of a brain, which is then analyzed by an advanced CNN model to predict one of four possible classes: 'glioma', 'meningioma', 'no tumor', or 'pituitary'. The model achieved 95% accuracy on the test set. Simply upload your X-ray image and let the CNN model offer insights into your brain's health status.")
...
#Upload file
st.write("Allowed extensions: png, jpeg, jpg")
